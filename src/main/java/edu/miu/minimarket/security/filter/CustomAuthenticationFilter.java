package edu.miu.minimarket.security.filter;
...
//        AuthenticationRequest creds = new AuthenticationRequest();
//        try {
//            creds = new ObjectMapper().readValue(request.getInputStream(), AuthenticationRequest.class);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
